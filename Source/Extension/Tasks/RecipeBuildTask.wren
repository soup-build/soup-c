...
import "mwasplund|Soup.C.Compiler:./BuildArguments" for BuildOptimizationLevel, BuildTargetType
import "mwasplund|Soup.C.Compiler:./CompileArguments" for LanguageStandard
