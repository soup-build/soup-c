...
import "Soup|C.Compiler:./BuildArguments" for BuildArguments, BuildOptimizationLevel, HeaderFileSet
...
import "Soup|C.Compiler.MSVC:./MSVCCompiler" for MSVCCompiler
