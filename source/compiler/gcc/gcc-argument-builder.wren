...
import "mwasplund|Soup.C.Compiler:./compile-arguments" for LanguageStandard, OptimizationLevel
import "mwasplund|Soup.C.Compiler:./link-arguments" for LinkTarget
