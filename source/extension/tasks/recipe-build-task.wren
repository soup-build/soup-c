...
import "mwasplund|Soup.C.Compiler:./build-arguments" for BuildOptimizationLevel, BuildTargetType
import "mwasplund|Soup.C.Compiler:./compile-arguments" for LanguageStandard
