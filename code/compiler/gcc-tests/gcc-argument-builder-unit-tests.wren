...
class GCCArgumentBuilderUnitTests {
	...
	RunTests() {
		System.print("GCCArgumentBuilderUnitTests.BSCA_SingleArgument_LanguageStandard(LanguageStandard.C11, \"-std=c11\")")
		this.BSCA_SingleArgument_LanguageStandard(LanguageStandard.C11, "-std=c11")
		System.print("GCCArgumentBuilderUnitTests.BSCA_SingleArgument_LanguageStandard(LanguageStandard.C17, \"-std=c17\")")
